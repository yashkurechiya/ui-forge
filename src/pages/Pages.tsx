...
import { categories, components } from "@/data/pages";
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <div className="container py-10 mt-10 flex-1">
        ...
        <p className="text-zinc-400 mb-8">Browse reusable React pages ready to copy into your project.</p>
                  ...
                  <button
                    ...
                    className={`w-full text-left rounded-md px-3 py-1.5 text-sm transition ${
                      activeCategory === cat
                        ...
                        : "text-muted-foreground hover:text-foreground hover:bg-blue-600 hover:text-white"
                    }`}
                  >
                    {cat}
                  </button>
